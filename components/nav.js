      ...
      <nav className="flex flex-col w-48 gap-3">
        ...
        >
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className={pathname === '/' ? activeIcon : 'w-6 h-6'}
          >
            <path
              strokeLinecap="round"
        ...
        >
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className={pathname.includes('/products') ? activeIcon : 'w-6 h-6'}
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
        ...
        <Link
          href={'/catagories'}
          className={
            pathname.includes('/catagories') ? activeLink : inactiveLink
          }
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            ...
            stroke="currentColor"
            className={
              pathname.includes('/catagories') ? activeIcon : 'w-6 h-6'
            }
          >
            <path
              strokeLinecap="round"
        ...
        >
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className={pathname.includes('/orders') ? activeIcon : 'w-6 h-6'}
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
        ...
        >
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className={pathname.includes('/settings') ? activeIcon : 'w-6 h-6'}
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
        ...
        <button className={inactiveLink} onClick={() => logout()}>
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className={pathname.includes('/logout') ? activeIcon : 'w-6 h-6'}
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
